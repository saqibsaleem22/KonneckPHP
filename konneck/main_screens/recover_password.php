...
<div class="signin-form">
    ...
    <div class="text-center small" style='color:#67428B;'>Back to signin?<a href="../login&Registration/login.php">Click here</a></div>
</div>
</body>
</html>
<?php
...
if(isset($_POST['submit'])){
    ...
    if($check_user==1){
        ...
        echo "<script>window.open('recover_password.php','_self')</script>";
    }
